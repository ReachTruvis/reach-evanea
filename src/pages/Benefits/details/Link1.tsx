    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            REACH Evanea brings textiles to life by showing how fabrics drape, fold, and interact with light, helping designs feel real, tangible, and ready for evaluation beyond flat repeats.
          </p>
