    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            High-quality, photoreal visuals make textile concepts more persuasive and easier to understand, helping accelerate discussions and reduce back-and-forth during reviews.
          </p>
