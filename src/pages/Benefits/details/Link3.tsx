    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            By visualizing textiles in real-world contexts such as upholstery, curtains, and décor, stakeholders can better understand design intent, leading to faster and more confident approvals.
          </p>
