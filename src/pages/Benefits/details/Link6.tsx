    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            The same textile visuals can be used across lookbooks, presentations, e-commerce, and campaigns, ensuring consistent and impactful storytelling across all channels.
          </p>
